   ...
   resetPassword=()=>{
      if(this.state.password === ""){
        ...
        let token = localStorage.getItem('token');
         let details = {password:this.state.password}
         api.post(Url+"/api/users/resetpwd",details,{headers:{"Authorization":token}})
         .then((response) => {
            NotificationManager.success('Reset successfully');
            this.setState({
                passwordError:false
             })
         })
                     ...
                     <div className="col-sm-8 col-lg-5 mx-auto">
                        <div className="session-body text-center">
                           ...
                           <Form>
                              ...
                              <FormGroup>
                                 <Button variant="contained" className="btn-info text-white btn-block btn-large w-100" onClick={this.resetPassword}>Reset</Button>
                              </FormGroup>
